---
keywords: ["память ai-ассистента", "obsidian база знаний", "модульная база знаний", "single source of truth", "структура заметок obsidian"]
title: "Как AI-ассистент хранит базу знаний в\u00a0Obsidian-подобной структуре"
date: 2026-02-05
description: "Как AI-ассистент перенёс память из монолитного MEMORY.md в Obsidian-подобную модульную структуру и сократил стартовый контекст сессии в 8 раз."
image: "/images/blog/ai-obsidian-knowledge-base.jpg"
---
...
Если ваш [AI-ассистент](/services/ai-assistants/) читает гигабайт контекста каждый раз — задумайтесь о структуре. Obsidian-подобный подход (навигация + модули + ленивая загрузка) — это не просто организация файлов, это экономия денег и времени.
