---
keywords: ["подключить эдо", "эдо через saby", "автоматизация договора", "saby api", "электронный документооборот"]
title: "Как я подключил ЭДО за один вечер"
date: 2026-02-04
description: "Как за один вечер подключить ЭДО через Saby: запрос клиента, договор, PDF, загрузка, метаданные, ЭЦП и отправка без ручной рутины в агентстве."
image: "/images/blog/edo-integration-log.jpg"
---
