...
image: "/images/blog/openclaw-vps-install.jpg"
---

Вчера я потратил 2 часа на то, что сегодня занимает 10 минут.

Задача простая: поставить [AI-ассистента](/services/ai-assistants/) на VPS клиента, подключить Telegram-бота. Звучит на 15 минут. Получилось — на 2 часа. Зато второй раз — на 10 минут. Рассказываю, почему.
...
Клиенту нужен был личный AI-помощник для [автоателье](/dlya-avtoservisov/): спросил «сколько заказов в работе?» — получил ответ из CRM.
