...
date: 2026-03-23
description: "Как мы заменили крик и хождение по паркингу на push-уведомления в PWA для автоателье Birson"
readtime: 3
metric:
  value: "10 чел"
  label: "пользуются каждый день"
---
...
Выбрали PWA, а не нативное приложение — App Store это долго, а PWA ставится с сайта за 10 секунд. Push-уведомления работают через Web Push API — нужен только Wi-Fi, не сотовая связь.
