          ...
          <div className="container">
            <div className="contacts-header">
              ...
              <p className="contacts-intro">
                Свяжитесь с нами удобным способом — ответим на все вопросы и обсудим ваш проект
              </p>
            </div>
                ...
                <div className="contact-methods">
                  ...
                  >
                    <div className="contact-icon">
                      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M14.5 11.5C14.5 12.9 13.4 14 12 14C10.6 14 9.5 12.9 9.5 11.5V9C9.5 7.6 10.6 6.5 12 6.5C13.4 6.5 14.5 7.6 14.5 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                        <path d="M12 14V17.5M9.5 17.5H14.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                      </svg>
                    </div>
                  ...
                  >
                    <div className="contact-icon">
                      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="1.5" />
                        <path d="M7 9.5L11.2929 12.7071C11.6834 13.0976 12.3166 13.0976 12.7071 12.7071L17 9.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <rect x="7" y="8.5" width="10" height="7" rx="1" stroke="currentColor" strokeWidth="1.5" />
                      </svg>
                    </div>
                    <div className="contact-info">
            ...
            <div className="why-choose">
              ...
              <div className="why-grid">
                <div className="why-item">
                  ...
                  <h3>Быстрая связь</h3>
                  <p>Отвечаем в течение нескольких часов. Всегда на связи в рабочее время.</p>
                </div>
                <div className="why-item">
                  <div className="why-icon">
                    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p>Каждый проект уникален. Разрабатываем решения под ваши задачи.</p>
                </div>
                <div className="why-item">
                  <div className="why-icon">
                    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="contacts-cta">
              ...
              <p>Напишите нам в Telegram или позвоните — проконсультируем бесплатно</p>
