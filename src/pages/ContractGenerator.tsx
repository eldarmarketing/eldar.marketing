    ...
    try {
      ...
      const docDefinition: any = {
        content: [
          ...
          {
            text: [
              'ИП Бурханов Эльдар Маратович\n',
              'ИНН: 027712049400\n',
              'ОГРНИП: 323028000174945\n',
              'Адрес: 450005, Республика Башкортостан, г. Уфа, ул. 50 лет СССР, д. 39, кв. 74\n',
          ...
          },
          {
            columns: [
              {
                text: '_______________ / Бурханов Э.М. /'
              },
              {
