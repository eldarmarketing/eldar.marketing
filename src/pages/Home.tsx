...
import { COMPANY, ABOUT, SERVICES_FULL, APPROACH_STEPS, CASES_PREVIEW_WITH_RESULTS, PLANETA_PROMO, ECOMMERCE_PROMO, CONTACTS } from '../constants/data'
          ...
          <div className="about-content">
            ...
            <div className="about-stats">
              <div className="stat-item">
                <AnimatedCounter end={10} suffix="+" className="stat-value" duration={2500} />
                <div className="stat-label">{ABOUT.stats[0].label}</div>
              </div>
              <div className="stat-item">
                <div className="stat-value">
                  <AnimatedCounter end={60} suffix="+ млн ₽" duration={2500} />
                </div>
                <div className="stat-label">{ABOUT.stats[1].label}</div>
              </div>
              <div className="stat-item">
                <AnimatedCounter end={50} suffix="+" className="stat-value" duration={2500} />
                <div className="stat-label">{ABOUT.stats[2].label}</div>
              </div>
              <div className="stat-item">
                <AnimatedCounter end={7} suffix="+" className="stat-value" duration={2500} />
                <div className="stat-label">{ABOUT.stats[3].label}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="approach-list">
            {APPROACH_STEPS.map((step, idx) => (
              <ScrollReveal key={step.number} animation="fadeInLeft" delay={idx * 100}>
                ...
                <ScrollReveal key={caseItem.id} delay={idx * 100}>
                  ...
                  >
                    <div className="case-header">
                      <h3>
                        {isAdCase ? (
                          ...
                          caseItem.title.split(' ').map((word, wordIdx) => (
                            <span key={wordIdx} className="water-text-word">
                              {word}{wordIdx < caseItem.title.split(' ').length - 1 ? ' ' : ''}
                            </span>
                          ))
                        ) : (
                          caseItem.title
                    ...
                    <div className="case-results">
                      {caseItem.previewResults.map((result, resultIdx) => (
                        <div key={resultIdx} className="result-item">
